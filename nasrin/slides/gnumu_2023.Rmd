...
author: "**Erik Amézquita**, Farzana Nasrain <br> Katie Storey, Masato Yoshizawa <br> -"
...
- Mapper is based on topological ideas:
    - It roughly preserves a notion of nearness, **but**
    - It can distort large scale distances. 
    - This is often a desirable property, because nearness at high dimensions can be unintuitive.
    
- Mapper reduces both dimension and data points.

- Novel visualization of large datasets.

- Computation is highly efficient and can deal with large amounts of data and dimensions

- Readily available software in python and R

- Plenty of pieces to move around

- Plenty of untapped potential for plant genomics
