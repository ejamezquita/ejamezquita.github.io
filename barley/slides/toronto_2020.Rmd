...
background-image: url("../figs/how-are-chromosomes-inherited1.png")
...
background-image: url("../figs/confusion_traditional_radial.png")
background-size: 450px
...
background-image: url("../figs/confusion_ect_radial.png")
background-size: 450px
background-position: 97% 95%
...
background-image: url("../figs/BarleySeed.png")
background-size: 450px
background-position: 99% 60%
