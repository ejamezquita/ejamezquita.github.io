...
date: "`r Sys.Date()` <br> - <br> Slides: [`https://bit.ly/cebada_atd`](https://www.egr.msu.edu/~amezqui3/barley/slides/sembiomat_2021.html)"
output:
...
.pull-left[
```{r, out.width="250px"}
knitr::include_graphics("../../tda/figs/simplicial_complex.jpg")
```
...
.pull-right[
```{r, out.width="250px"}
knitr::include_graphics("../../tda/figs/cubical_complex.jpg")
```
