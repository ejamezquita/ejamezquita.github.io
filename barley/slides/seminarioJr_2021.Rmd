...
.pull-left[
```{r, out.width="250px"}
knitr::include_graphics("../figs/complex-good.png")
```
...
.pull-right[
```{r, out.width="250px"}
knitr::include_graphics("../figs/cubical_complex_example.jpg")
```
...
```{r, out.width="600px"}
knitr::include_graphics("../figs/cubical_complex_es.png", auto_pdf = TRUE)
```
...
knitr::include_graphics("lab200330.pdf")
```
...
```{r, out.width="600px"}
knitr::include_graphics("../figs/curse_of_dimensionality.png")
```
...
```{r, out.width="270px"}
knitr::include_graphics("../figs/concentration-circle.png")
```
...
background-image: url("../figs/kernel_trick.png")
