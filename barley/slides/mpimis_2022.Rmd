...
author: "**Erik Amézquita** <br> - <br> Computational Mathematics, Science, and Engineering <br> Michigan State University <br> -"
date: "`r Sys.Date()`"
output:
...
<div class="row">
  ...
  <div class="column" style="max-width:18%">
    <a href="https://doi.org/10.1002/ppp3.10333" target="_blank"><img style="padding: 0 0 0 0;" src="../../citrus/figs/SR01_L01_exocarp.gif"></a>
  </div>
...
1. Modeling citrus fruit shape and oil glands

1. Directional statistics and ideas

1. Teaser of ongoing projects
...
## The oil gland centers will be just fine
...
<div class="row" style="margin:auto">
  <div class="column" style="max-width:60%">
    <img src="https://upload.wikimedia.org/wikipedia/commons/0/0e/Ellipsoid-affin.svg">
  </div>
  <div class="column" style="max-width:10%">
    <img src="https://preview.redd.it/ih6no69aj90y.png?auto=webp&s=8e4f9101f58e0812f3625a51ec65c9b7c050da75">
  </div>
  <div class="column" style="max-width:30%">
    <img src="../../citrus/figs/lambert_equal_area_N.gif">
  </div>
</div>
...
## Distortions with elongated citrus: Kumquat
...
- Analyze the morphology of 3M protein structures available from open repositories

- The shape of molecular coupling/decoupling

.pull-left[
![](../../proteins/figs/protein_vr.png)
]

.pull-right[
![](../../proteins/figs/protein_vr.gif)
]
...
<div class="row" style="margin-top: -25px;">
  ...
  <ul style="font-size: 12px">
    ...
    <p style="text-align: center; color: White; font-size:15px; line-height:1.1">Slides made in xaringan and rmarkdown</p>
  </div>
</div>
