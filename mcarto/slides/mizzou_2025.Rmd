...
### Visual intuition &rarr; Numbers

### Numbers &rarr; Visual intuition
...
The interdisciplinarity of plant research at MU has been key to my professional development.
...
# 2. Characterizing spatial patterns and distributions
...
- Another regulational mechanism: Spatial segregation and asymmetrical distribution of mRNA across the cytosol.
...
- Use the mathematical framework to differentiate patterns across cell types and genotypes.
...
# Molecular Cartography&trade; data
