---
title: "The Differential Subcellular Localization of Soybean Transcripts"
subtitle: "An Additional Regulatory Mechanism of Gene Activity"
...
date: "2025-07-25<br>*[Manuscript under review]*"
output:
...
# 1. mRNA localization to characterize cell types

### 2. Topological Data Analysis (TDA) to model localization patterns

### 3. Results and discussion

---

## Different nuclear versus cytosolic compartmentalizations across cell types

![](../figs/infected_density.jpg)
...
![](../figs/vascular_density.jpg)

---

# Density of transcripts versus cell location
...
# How *patterny* is a pattern?

![](../figs/cell_sample.jpg)
...
slides_text <- glue::glue_data(
  slides_info,
  "
  # Modeling with Topological Data Analysis
